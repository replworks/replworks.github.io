...
`AI_MEMORY.md`는 프로젝트 문서가 아니다.

---

`AI_MEMORY.md`는 세션 복구 문서다.
...
새로운 채팅을 시작한 뒤 첫 메시지로 `AI_MEMORY.md`를 전달한다.

---

LLM은 어떤 규칙으로도 `AI_MEMORY.md`를 자동 참조하지 않는다.
...
어떤 세션이든 `AI_MEMORY.md`로 이어갈 수 있어야 한다.
