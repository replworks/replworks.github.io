...
| 주요 산출물      | Workflow, Agent           | AGENTS.md, ARCHITECTURE.md, TASKS.md, AI_MEMORY.md |
...
## 왜 AI_MEMORY.md가 필요한가?

> 채팅 기록은 사라질 수 있지만, AI_MEMORY.md는 기억되어야 할 맥락만 남긴다.

사람은 모든 것을 기억하지 않습니다.

시간이 지나면 세부사항은 잊어버리고 중요한 맥락만 장기기억으로 남깁니다.

AI_MEMORY.md는 AI를 위한 장기기억입니다.

프로젝트가 끝나거나 중요한 작업이 완료되면 AI는 장기적으로 유지해야 할 맥락만 AI_MEMORY.md에 기록합니다.
...
AI_MEMORY.md는 채팅 기록이 아닙니다.

채팅에서 살아남은 기억입니다.

---

## 누가 AI_MEMORY.md를 작성하는가?

> AI_MEMORY.md는 AI가 작성하고 인간이 승인하는 프로젝트의 장기기억입니다.

AI_MEMORY.md는 사람이 작성하지 않습니다.
